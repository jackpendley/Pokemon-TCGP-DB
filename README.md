...
Requirements before recommendations can be made:
- Metadata enrichment must be sufficiently complete (set, rarity, card_category)
- Pack/source mapping must be built (`data/reference/pack_sources.json`)
- Current meta data must be available
